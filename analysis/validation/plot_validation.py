...
for iteration in files:
    filename = f"data/Validation_DistinctSamples10_MaxSteps100000_Repi1_{iteration}.csv"
    df = df.append(pd.read_csv(filename))
    filename = f"data/Validation_DistinctSamples9_MaxSteps100000_Repi1_{iteration}.csv"
    df = df.append(pd.read_csv(filename))
    filename = f"data/Validation_DistinctSamples19_MaxSteps100000_Repi1_{iteration}.csv"
    df = df.append(pd.read_csv(filename))
